...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-c-schulz.git;protocol=ssh;branch=main"

PV = "1.0+git${SRCPV}"
# DONE: set to reference a specific commit hash in your assignment repo
SRCREV = "6c9cb2b886cb19371cc558689637706b70ca4f12"
